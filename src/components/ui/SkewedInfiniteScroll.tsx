  ...
  return (
    <div>
      <div className="flex items-center justify-center">
        <div className="relative w-[800px] h-[400px] max-w-screen-lg overflow-hidden bg-gray-800">
          {/*<div className="pointer-events-none absolute -top-1 z-10 h-20 w-full bg-gradient-to-b from-gray-900"></div>*/}
          {/*<div className="pointer-events-none absolute -bottom-1 z-10 h-20 w-full bg-gradient-to-t from-gray-900"></div>*/}
          {/*<div className="pointer-events-none absolute -left-1 z-10 h-full w-20 bg-gradient-to-r from-gray-900"></div>*/}
          {/*<div className="pointer-events-none absolute -right-1 z-10 h-full w-20 bg-gradient-to-l from-gray-900"></div>*/}
